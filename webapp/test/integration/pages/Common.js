sap.ui.define([
	...
	function getFrameUrl(sHash, sUrlParameters) {
		var sUrl = jQuery.sap.getResourcePath("twm/net/ZFORMATION_09/app", ".html");
		sHash = sHash || "";
		sUrlParameters = sUrlParameters ? "?" + sUrlParameters : "";

		if (sHash) {
			sHash = "#CRUDApplication-display&/" + (sHash.indexOf("/") === 0 ? sHash.substring(1) : sHash);
		} else {
			sHash = "#CRUDApplication-display";
		}

		return sUrl + sUrlParameters + sHash;
	}

	return Opa5.extend("twm.net.ZFORMATION_09.test.integration.pages.Common", {
		...
		getMockServer: function () {
			return new Promise(function (success) {
				Opa5.getWindow().sap.ui.require(["twm/net/ZFORMATION_09/localService/mockserver"], function (mockserver) {
