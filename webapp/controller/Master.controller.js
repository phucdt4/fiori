/*global history */
sap.ui.define([
	"twm/net/ZFORMATION_09/controller/BaseController",
	"sap/ui/model/json/JSONModel",
	"sap/ui/model/Filter",
	"sap/ui/model/FilterOperator",
	"sap/m/GroupHeaderListItem",
	"sap/ui/Device",
	"twm/net/ZFORMATION_09/model/formatter",
	"sap/m/MessageBox",
	"twm/net/ZFORMATION_09/model/grouper",
	...
	return BaseController.extend("twm.net.ZFORMATION_09.controller.Master", {
		...
		onOpenViewSettings: function () {
			if (!this._oViewSettingsDialog) {
				this._oViewSettingsDialog = sap.ui.xmlfragment("twm.net.ZFORMATION_09.view.ViewSettingsDialog", this);
