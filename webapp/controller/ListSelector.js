sap.ui.define([
	...
	return BaseObject.extend("twm.net.ZFORMATION_09.model.ListSelector", {
		 ...
		 * @class
		 * @public
		 * @alias twm.net.ZFORMATION_09.model.ListSelector
		 */
		 ...
		 * @return {twm.net.ZFORMATION_09.model.ListSelector} the list selector object for method chaining
		 * @public
		 */
